...
const ModernCategoryItem = memo(({ category }: { category: any }) => {
...
ModernCategoryItem.displayName = "ModernCategoryItem";

// Componente principal de Categorias Modernas
export const ModernCategories = () => {
